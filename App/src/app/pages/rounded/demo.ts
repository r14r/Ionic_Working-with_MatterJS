...
@Component({
	selector: 'app-rounded-page',
	templateUrl: './rounded.page.component.html',
	styleUrls: ['./rounded.page.component.scss']
})
export class RoundedPageComponent implements OnInit {
