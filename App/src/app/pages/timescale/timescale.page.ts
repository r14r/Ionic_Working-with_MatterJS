...
import { Body, Engine, Events, Render, World, Common, Bodies, Runner, Composite, Composites, Mouse, MouseConstraint } from 'matter-js'; import { HelperService } from 'src/app/helpers/helper.service';

@Component({
	selector: 'app-timescale',
	templateUrl: './timescale.page.html',
	styleUrls: ['./timescale.page.scss'],
})
export class TimescalePage implements OnInit {
	private helper = new HelperService('TimescalePage');
