...
@Component({
	...
	templateUrl: './avalanche.page.html',
	styleUrls: ['./avalanche.page.scss'],
})
export class AvalanchePage implements OnInit {
	private helper = new HelperService('AvalanchePage');
