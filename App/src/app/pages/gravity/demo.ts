...
@Component({
	...
	selector: 'app-gravity-page',
	templateUrl: './gravity.page.component.html',
	styleUrls: ['./gravity.page.component.scss']
})
export class GravityPageComponent implements OnInit {
